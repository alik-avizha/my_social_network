...
export type ChatActionsType =
    | ReturnType<typeof messagesReceivedActionCreator>
    | ReturnType<typeof statusChangedActionCreator>
    | ReturnType<typeof clearDataActionCreator>
